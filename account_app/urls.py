...
from .views import CustomLoginView, UserProfileView, ProfileEditView, ProfileImageEditView, CustomPasswordChangeView
...
urlpatterns = [
    ...
    path('dashboard/settings/security/', CustomPasswordChangeView.as_view(), name = 'user-security'),
