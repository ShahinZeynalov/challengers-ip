...
from .views import CustomLoginView, UserProfileView, ProfileEditView, ProfileImageEditView, ChangePasswordFormView
...
urlpatterns = [
    ...
    path('dashboard/settings/security/', ChangePasswordFormView.as_view(), name = 'user-security'),
